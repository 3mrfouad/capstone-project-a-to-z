...
namespace AZLearn.Models
{
    ...
    public class Homework
    {
        ...
        [Column(TypeName = "float(5,2)")] public float AvgCompletionTime { get; set; } = 0;
        ...
        [Column(TypeName = "datetime")] public DateTime? ReleaseDate { get; set; }

        [Column(TypeName = "varchar(250)")] public string DocumentLink { get; set; }

        [Column(TypeName = "varchar(250)")] public string GitHubClassRoomLink { get; set; }
